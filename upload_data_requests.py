...
def send(mote,packet_tcflow,temperature,humidity,gasValue,gasAlarm):
  raw_data = '{"m2m:cin": { "cnf": "json",	"con": " { "Mote":"'+mote+'", "Priority":"'+str(packet_tcflow)+'", "EnvTemp":"'+str(temperature*0.01)+'", "EnvHumi":"'+str(humidity*0.01)+'", "EnvCO":"'+str(gasValue)+'", "Alarm":"'+str(gasAlarm)+'" } "	} }'
